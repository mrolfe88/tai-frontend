...
check.current.income=Gwiriwch eich ffynonellau Incwm TWE presennol a’ch manylion Treth Incwm ar gyfer y flwyddyn dreth bresennol, {0}.
...
error.invalid.monetaryAmount.format.invalid=Nodwch y swm mewn punnoedd cyfan - anwybyddwch y ceiniogau
...
tai.bonusPayments.error.form.incomes.radioButton.mandatory=Dewiswch ‘Iawn’ os fyddwch yn cael unrhyw daliadau bonws neu daliadau goramser rhwng {0}
tai.bonusPayments.error.form.likely=Dewiswch Iawn os ydych yn debygol o gael rhagor o daliadau bonws neu oramser eleni
tai.bonusPayments.moreThisYear=A ydych yn meddwl y cewch ragor o daliadau bonws neu daliadau oramser drwy gydol y flwyddyn?
...
tai.checkYourAnswers.title=Gwiriwch eich atebion
tai.checkYourAnswers.heading=Gwiriwch eich atebion
...
tai.estimatedPay.basicPayExplanation=Dyma’ch cyflog gros cyn i unrhyw beth gael ei dynnu ohono.
tai.estimatedPay.checkTaxEstimate=Cadarnhau ac anfon
tai.estimatedPay.error.incorrectTaxableIncome.button=Dechrau eto
tai.estimatedPay.error.incorrectTaxableIncome.description=Rhoddodd eich cyflogwr wybod i ni y talwyd £{0} i chi hyd at fis {1}. Ni allwch roi swm blynyddol sy''n llai na hwnnw. I newid eich manylion incwm, cysylltwch â Chyllid a Thollau EM ar 0300 200 1900.
...
tai.estimatedPay.error.incorrectTaxableIncome.title=Mae gwall yn eich cyfrifiad lol
tai.estimatedPay.error.incorrectTaxableIncome.heading=Mae gwall yn eich cyfrifiad
...
tai.estimatedPay.preHeading=Diweddarwch eich incwm amcangyfrifedig oddi wrth {0}
tai.estimatedPay.title=Eich cyflog amcangyfrifedig ar gyfer {0}
tai.estimatedPay.heading=Eich cyflog amcangyfrifedig ar gyfer {0}
tai.estimatedPay.weHaveCalculated=Rydym wedi cyfrifo’ch cyflog amcangyfrifedig ar gyfer y flwyddyn dreth bresennol yn seiliedig ar yr atebion yr ydych wedi eu rhoi.
tai.estimatedPay.whyLower.message=Dechreuoch gyflogaeth ar {0}. Mae hyn yn golygu bod eich cyflog yn ystod blwyddyn dreth {1} yn llai na''ch cyflog blynyddol. Yn seiliedig ar y ffigurau a roddwyd gennych, amcangyfrifwn mai''ch cyflog blynyddol yw £{2}.
...
tai.howToUpdate.enterAnnual=Nodwch swm amcangyfrifedig ar gyfer y flwyddyn lawn
tai.howToUpdate.error.form.incomes.radioButton.mandatory=Dewiswch os ydych am ddefnyddio slip cyflog i gyfrifo’ch amcangyfrif neu os ydych am nodi amcangyfrif ar gyfer y flwyddyn lawn
tai.howToUpdate.incomeCalculator=Nodwch symiau o slip cyflog diweddar i’w gyfrifo
tai.howToUpdate.preHeading=Diweddarwch eich incwm amcangyfrifedig oddi wrth {0}
tai.howToUpdate.heading=Sut ydych am ddiweddaru eich incwm amcangyfrifedig {0}?
tai.howToUpdate.title=Sut ydych am ddiweddaru eich incwm amcangyfrifedig
...
tai.income.previousYears.decision.title=Diweddaru manylion incwm ar gyfer {0}
...
tai.incomes.landing.pension.ended=Os nad ydych yn cael incwm oddi wrth {0}
...
tai.incomes.confirm.save.message.details=Gall newid eich swm newid eich cod treth a’r haen dreth yr ydych ynddi. Gallai hynny effeithio ar swm y dreth yr ydych yn ei thalu.
tai.incomes.confirm.save.message=Eich incwm amcangyfrifedig newydd yw £{0}.
...
tai.incomes.confirm.save.heading=Cadarnhewch eich incwm trethadwy amcangyfrifedig ar gyfer {0}
...
tai.incomes.edit.title=Diweddarwch eich incwm trethadwy amcangyfrifedig ar gyfer {0}
...
tai.incomes.edit.howTo.grossAmount=Os na ddangosir hyn ar eich slip cyflog, gallwch weithio allan eich cyflog trethadwy drwy ddod o hyd i’ch swm gros a didynnu eitemau nad ydynt yn drethadwy, megis:
tai.incomes.edit.howTo.payslip=Efallai bod gan eich slip cyflog ffigur “cyflog trethadwy” neu “gros ar gyfer treth”. Lluoswch hwn gan sawl gwaith y cewch eich talu yn ystod blwyddyn i greu swm blynyddol.
...
tai.incomes.edit.preHeading=Diweddarwch eich incwm amcangyfrifedig oddi wrth {0}
...
tai.payPeriod.error.form.incomes.radioButton.mandatory=Dewiswch os ydych am gael eich talu’n fisol, yn wythnosol, bob pythefnos neu nifer gwahanol o ddiwrnodau
tai.payPeriod.fortnightly=Bob 2 wythnos
tai.payPeriod.howOften=Sawl diwrnod sydd rhwng bob diwrnod cyflog?
...
tai.paye.heading=Eich incwm trethadwy ar gyfer {0}
...
tai.paye.incomeEmployment.heading=Eich incwm o gyflogaeth
...
tai.paye.lastTaxYear.incorrectInformation.title=Os ydych o’r farn bod yr wybodaeth hon yn anghywir
tai.paye.lastTaxYear.incorrectInformation.text=Os yw’r manylion incwm ar gyfer y flwyddyn yn anghywir, gallwch
tai.paye.lastTaxYear.incorrectInformation.link=anfon diweddariad atom.
...
tai.payslip.error.form.totalPay.mandatory=Nodwch gyfanswm y cyflog sydd ar eich slip cyflog
...
tai.taxCode.0T=Defnyddiwyd eich Lwfans Personol i gyd, neu rydych wedi dechrau cyflogaeth newydd ac nid oes gan eich cyflogwr y manylion sydd eu hangen arno i roi cod treth i chi.
tai.taxCode.BR=Mae’ch holl incwm o’r gyflogaeth hon neu’r pensiwn hwn yn cael ei drethu ar y gyfradd sylfaenol o 20%. Gallai hyn fod oherwydd bod gennych fwy nag un gyflogaeth neu bensiwn.
tai.taxCode.C=Trethir eich cyflogaeth neu’ch pensiwn gan ddefnyddio’r cyfraddau yng Nghymru. {0}
tai.taxCode.DX=Mae’ch holl incwm o’r gyflogaeth hon neu’r pensiwn hwn yn cael ei drethu ar {0}%. Gallai hyn fod oherwydd bod gennych fwy nag un gyflogaeth neu bensiwn.
tai.taxCode.K=Mae gennych incwm heb ei drethu sy’n fwy na’ch swm rhydd o dreth. Mae hwn wedi cael ei ychwanegu at eich cyflog neu’ch pensiwn fel y gellir casglu’r dreth ychwanegol.
tai.taxCode.L=Mae gennych hawl i’r Lwfans Personol safonol sy’n rhydd o dreth. Bydd eich cod treth yn cael ei ddiweddaru’n awtomatig os bydd y Lwfans Personol rhydd o dreth yn newid.
...
tai.taxCode.S=Trethir eich cyflogaeth neu’ch pensiwn gan ddefnyddio’r cyfraddau yn yr Alban. {0}
...
tai.taxCode.X=Seilir eich treth ar eich cyflog ym mhob cyfnod cyflog, nid y flwyddyn gyfan. Mae hyn yn eich atal rhag talu gormod o dreth ar un tro. Gallai’ch slip cyflog neu ddatganiad eich pensiwn ddangos hyn fel W1/M1, neu wythnos 1/mis 1.
tai.taxCode.amount=Eich swm sy’n rhydd o dreth ar gyfer y gyflogaeth hon neu’r pensiwn hwn yw £{0}.
tai.taxCode.definition.announce=– Diffiniad y rhan hon o’ch cod treth yw:
tai.taxCode.multiple.code.title=Eich codau treth ar gyfer {0} i {1}
...
tai.taxCode.welshIncomeText.link=Darllenwch am Dreth Incwm Cymru yn GOV.UK (yn agor ffenestr neu dab newydd)
tai.taxCode.sideBar.heading=Deall eich treth
tai.taxCode.single.code.title=Eich cod treth ar gyfer {0} i {1}
...
tai.taxCode.prev.K=Roedd gennych incwm heb ei drethu a oedd yn fwy na’ch swm rhydd o dreth. Ychwanegwyd hwn i’ch cyflog neu’ch pensiwn er mwyn gallu casglu’r dreth ychwanegol.
tai.taxCode.prev.L=Roedd gennych hawl i’r Lwfans Personol safonol rhydd o dreth.
tai.taxCode.prev.M=Lwfans Priodasol: cawsoch drosglwyddiad o 10% o Lwfans Personol eich partner.
...
tai.taxCode.prev.multiple.code.title=Eich codau treth diwethaf ar gyfer blwyddyn dreth {0} i {1}
tai.taxCode.prev.multiple.info=Defnyddiwyd eich codau treth i gyfrifo faint o Dreth Incwm i’w thynnu o’ch cyflog neu’ch pensiwn.
tai.taxCode.prev.preHeader=Blynyddoedd treth blaenorol
tai.taxCode.prev.single.code.title=Eich cod treth diwethaf ar gyfer blwyddyn dreth {0} i {1}
tai.taxCode.prev.single.info=Defnyddiwyd eich cod treth i gyfrifo faint o Dreth Incwm i’w chymryd o’ch cyflog neu’ch pensiwn.
tai.taxCode.prev.subheading=Eich cod treth ar gyfer {0} o {1} i {2} oedd {3}
...
tai.taxFreeAmount.summarysection.p2=Gall fod:
tai.taxFreeAmount.summarysection.taxFreeExplanation=Mae’ch cod treth wedi’i gyfrifo o’ch swm rhydd o dreth. Eich swm rhydd o dreth yw’r incwm y gallwch ei gael cyn dechrau talu treth ac unrhyw ychwanegiadau neu ddidyniadau.
...
tai.taxYearHeading=Blynyddoedd treth erail
tai.taxablePayslip.error.form.incomes.radioButton.mandatory=Rhowch y cyflog trethadwy sydd ar eich slip cyflog
tai.taxablePayslip.error.form.payTooHigh=Mae’n rhaid i’ch cyflog trethadwy fod yn {0} neu’n llai
...
tai.unableToCalculate.preHeading=Diweddarwch eich incwm amcangyfrifedig oddi wrth {0}
...
tai.workingHours.irregularHours=Yn afreolaidd (er enghraifft, gwaith sifft neu waith adeg y tymor)
tai.workingHours.error.form.incomes.radioButton.mandatory=Dewiswch os yw eich oriau gwaith arferol yn rheolaidd neu’n afreolaidd
...
taxCode.change.yourTaxCodeChanged.previousTaxCodes=Codau treth blaenorol
taxCode.change.yourTaxCodeChanged.currentTaxCodes=Codau treth presennol
...
tai.estimatedPay.update.checkYourAnswers.hasBonusOrOvertime = A fyddech yn cael unrhyw daliadau bonws neu daliadau goramser rhwng {0}?
tai.estimatedPay.update.checkYourAnswers.totalBonusOrOvertime = Swm y taliadau bonws neu oramser {0}?
tai.estimatedPay.update.checkYourAnswers.totalYearlyBonusOrOvertime = Cyfanswm y taliadau bonws neu oramser ar gyfer {0}
